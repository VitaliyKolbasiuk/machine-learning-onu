...
# Підрахунок початкової кількості спостережень
initial_count = X.shape[0]
print(f"Початкова кількість спостережень: {initial_count}")
...
# Підрахунок кількості спостережень після видалення викидів
final_count = X_cleaned.shape[0]
print(f"Кількість спостережень після видалення викидів: {final_count}")
print(f"Видалено {initial_count - final_count} спостережень.")
